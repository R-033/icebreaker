...
namespace Hypercooled.Carbon.Core
{
	public class SceneryObject : Shared.Core.SceneryObject
	{
		...
		public uint LightTextureKey1 { get; set; }
		public uint LightTextureKey2 { get; set; }
		public uint LightTextureKey3 { get; set; }
		public uint DirectionalMapKey { get; set; }
		...
		public string LightTextureName1
		{
			get => this.LightTextureKey1.BinString();
			set => this.LightTextureKey1 = value.BinHash();
		}
		public string LightTextureName2
		{
			get => this.LightTextureKey2.BinString();
			set => this.LightTextureKey2 = value.BinHash();
		}
		public string LightTextureName3
		{
			get => this.LightTextureKey3.BinString();
			set => this.LightTextureKey3 = value.BinHash();
		}
		public string DirectionMapName
		{
			get => this.DirectionalMapKey.BinString();
			set => this.DirectionalMapKey = value.BinHash();
		}
		...
		public override void Serialize(BinaryWriter bw)
		{
			...
			/* 0xD8 */ bw.Write(this.LightTextureKey1);
			/* 0xDC */ bw.Write(this.LightTextureKey2);
			/* 0xE0 */ bw.Write(this.LightTextureKey3);
			/* 0xE4 */ bw.Write(this.DirectionalMapKey);

			/* 0xE8 */ bw.Write(this.SpawnerReplacementKey);
			/* 0xEC */ bw.Write(this.SpawnerCollisionKey);
			/* 0xF0 */ bw.Write(this.SpawnerAttributes);
			/* 0xF4 */ bw.Write(this.SpawnerExcludeFlags);
			/* 0xF8 */ bw.Write(this.SpawnerSpawnFlags);
			/* 0xFC */ bw.Write(this.SceneryGroups.Count);
		...
		public override void Deserialize(BinaryReader br)
		{
			...
			/* 0xD8 */ this.LightTextureKey1 = br.ReadUInt32();
			/* 0xDC */ this.LightTextureKey2 = br.ReadUInt32();
			/* 0xE0 */ this.LightTextureKey3 = br.ReadUInt32();
			/* 0xE4 */ this.DirectionalMapKey = br.ReadUInt32();

			/* 0xE8 */ this.SpawnerReplacementKey = br.ReadUInt32();
			/* 0xEC */ this.SpawnerCollisionKey = br.ReadUInt32();
			/* 0xF0 */ this.SpawnerAttributes = br.ReadUInt32();
			/* 0xF4 */ this.SpawnerExcludeFlags = br.ReadUInt32();
			/* 0xF8 */ this.SpawnerSpawnFlags = br.ReadUInt32();
			/* 0xFC */ uint sceneryGroupCount = br.ReadUInt32();

...
namespace Hypercooled.MostWanted.MapStream
{
	...
	public class DrivableScenerySection // 0x00034153
	{
		...
		public ushort SectionNumber => SectionParams.SectionNumber;
		public DrivableScenerySectionInternal SectionParams { get; set; }
		public ushort[] VisibleSections
		{
			get => m_visibleSections;
			set => m_visibleSections = value ?? new ushort[0];
		}
		...
		public int SizeOf => DrivableScenerySectionInternal.SizeOf + m_visibleSections.Length * 0x02;
	}
}

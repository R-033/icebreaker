...
namespace ELFSharp.ELF.Sections
{
    internal sealed class SectionHeader
    {
        ...
        internal ulong SizeOffset { get; private set; }
		internal ulong Offset { get; private set; }
        internal ulong OffsetOffset { get; private set; }
        ...
        private void ReadSectionHeader()
        {
            ...
            OffsetOffset = (ulong)reader.BaseStream.Position;
            Offset = ReadOffset();
            SizeOffset = (ulong)reader.BaseStream.Position;
            Size = ReadOffset();
